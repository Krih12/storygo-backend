...
const { avatarUpload } = require('../middleware/upload');   // <-- import avatarUpload
...
// Avatar & password routes - using the imported middleware
router.post('/avatar', avatarUpload, userController.uploadAvatar);   // <-- fixed
